...
You have three channels into the same market: **recruiters** who run the searches, **bankers** who see distress before it's public, and **PE firms** who own the companies and authorize the swap. Hit all three in parallel this week.

The **single highest-leverage move** is the talent partners at software-focused PE firms (Grace Kim at FP, Hilary Gosher at Insight, Elizabeth Knuppel at Vista) — each indexes across dozens of portcos at once. Pair them with **two boutique recruiters** that live in the PE-portfolio-SaaS-CEO niche (Bespoke Partners, Notch Partners) and **two restructuring bankers** who hold the distress dealflow (Steve Zelin at PJT, Jim Mesterharm at AlixPartners). That five-firm cluster covers most of the addressable market.

QA flagged 3 corrections from the raw research, applied below. The package is ready to send.
...
| Rank | Name | Firm | Role | Channel | Email | Why first |
|---|---|---|---|---|---|---|
| **1** | **Grace Kim** | Francisco Partners | Partner, Head of Talent | PE | grace.kim@franciscopartners.com | One conversation = awareness across all of FP's $45B software portfolio. Talent partner = highest portfolio-wide leverage. |
| **2** | **Kristie Nova** | Bespoke Partners | Founding Partner, CEO Search | Recruiter | kristie@bespokepartners.com | Bespoke = the dominant PE-portfolio SaaS CEO firm. 307 placements in 2025. Gets you on the "available CEO" list shown to Thoma Bravo/Vista/Insight/Clearlake weekly. |
| **3** | **Hilary Gosher** | Insight Partners | MD, Founder of Insight Onsite | PE | hilary.gosher@insightpartners.com | 130+ person operating bench at Insight; Talent sub-team reports to her. 300+ portfolio companies. |
...
**Recruiters:** Eric Walczykowski (Bespoke CEO), Katherine Baker (Bespoke), Alexandra Bossetta (Bespoke), Jeff Sanders + Michael Nieset (Heidrick — tag-team), Stephanie Davis (Korn Ferry), Pat Haggerty (True), Shawn Banerji (Caldwell), John Marshall (JM Search), Rob Huxtable (Falcon Partners), John Hoagland (Vardis).

**Bankers:** Greg Galligan + Pete Fisher (Vista Credit Partners — co-heads), Ronen Bojmel (Guggenheim), Tyler Cowan (Lazard), Bill Derrough (Moelis), Erik Bissonnette (Blue Owl), Mark Solovy (Monroe), Bob Casey (Moelis), Steve Kuo (Hercules), Roopesh Shah (Evercore), Ted Smith (Union Square Advisors), Maria Lewis Kussmaul (AGC).

**PE Firms:** William Chisholm (STG), Behdad Eghbali (Clearlake), David Humphrey (Bain Capital), Bruce Chizen (Permira Senior Adviser — ex-Adobe CEO; ideal operator-to-operator intro), Aaron Goldman (General Atlantic), Eli Weiss (Genstar), Holden Spaht (Thoma Bravo), Brittany Stewart (FP Sr. Operating Advisor, Executive Talent), Brian Ruder (Permira).
...
## OUTREACH SEQUENCE — Week 1 calendar

**Monday, May 25:**
- Send first 5 emails (Grace Kim, Kristie Nova, Hilary Gosher, Andy Thompson, Elizabeth Knuppel) before 8am ET so they land top of inbox.
- LinkedIn connection requests to same 5 with a one-line note (don't paste the email).

**Tuesday, May 26:**
- Send next 5 (Jenny Gray, Hudson Smith, Jim Citrin, Steve Zelin, Jim Mesterharm).
- Steve Zelin's office number is public (212-364-2400) — leave a 30-second voicemail mid-morning if no email response by Tue afternoon.
...
## EMAIL TEMPLATES — Use these as scaffolds, personalize the opener

### Template A — PE Talent Partner (Kim, Gosher, Knuppel)

> Subject: Available SaaS CEO — built the most profitable B2B SaaS in [segment]
>
> [Name],
>
...
### Template B — PE-Focused Recruiter (Nova, Gray, Thompson, Hancock, Usina)

> Subject: Turnaround SaaS CEO with intact team — for your bench
>
> [Name],
>
...
> — Open to PE-backed, public, or pre-bankruptcy carve-out situations
>
> 20 minutes this week if you're open. [Calendar link] or two windows works.
>
> [Signature]

### Template C — Restructuring Banker (Zelin, Mesterharm, Lund)

> Subject: Operator-CEO available — distressed B2B SaaS
>
> [Name],
>
...
### Template D — Software M&A Banker / Senior Operating Adviser (Citrin, McGovern, Chizen)

> Subject: Brief intro — turnaround CEO seeking next chapter
>
> [Name],
>
...
The QA agent verified 18 of 20 priority contacts against firm websites and recent press as of May 2026. **Three corrections applied:**

1. **Vista Credit Partners:** David Flannery stepped back to Senior Advisor in 2025. Primary contacts are now **Greg Galligan + Pete Fisher** (Co-Heads). VCP is moved from Week 1 top-15 to Week 2 — give yourself time to verify their current titles before sending.
2. **Patrick Severson** is **Co-Head** (not sole head) of Vista Foundation Fund — title corrected in deliverable.
3. **Notch Partners** HQ is **Millburn, NJ** (not Far Hills) — fixed.

All 35 recruiter names, 62 banker names, and 50+ PE firm contacts are in the segment-specific files (`01-recruiters-research.md`, `02-bankers-research.md`, `03-pe-firms-research.md`) for the second and third waves.

---

## DO BEFORE SENDING

1. **Verify emails:** Run the top 15 names through ZoomInfo, RocketReach, or Apollo to lock direct addresses. Where bounces happen, the firm patterns above (`first.last@firm.com` etc.) will catch 80%+ on a second try.
2. **Update LinkedIn:** Your "Open to Work" should NOT be visible (these audiences treat that signal as desperate). Update the headline to something like "CEO | B2B SaaS | Turnaround-focused next chapter."
3. **One-pager:** Have a clean 1-page operating bio + headline-metric proof point ready to attach when asked. Don't attach it cold — it kills response rates.
4. **Calendar link:** Calendly or similar, with 20-min and 45-min slots open all week.
5. **Team availability statement:** Be precise about who is willing to follow — names + roles if you can say them, "intact senior team" if you can't. PE talent partners ask this question on first call.
6. **Reference list:** Have 5 board / investor references ready. PE talent partners will run them BEFORE introducing you to a portco.

---

## METRICS TO TRACK THIS WEEK

- **Response rate:** Target >40% on the top 15 (these are warm-channel-equivalents given your profile)
- **Calls scheduled:** Target 8 calls in Week 2 from this batch
- **Referrals collected:** Target 2+ per call (always ask: "who else should I be talking to?")
- **Specific situations surfaced:** Target 3+ named portcos / companies discussed concretely
