...
I'd value 20 minutes to share the operating model that worked at Trilogy and understand where it might fit - whether against a current FP portco or a situation you're tracking.
...
- **No attachment, no bio.** She'll ask if she's interested. Attaching cold reduces response rates ~15%.
...
- **What to expect on the call:** She'll ask (a) reference list, (b) financial outcome at Trilogy with specifics, (c) which team members will follow you and what their roles would be, (d) what you walk away from versus what you'd take on. Have crisp answers.
